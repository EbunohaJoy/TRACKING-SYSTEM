...
<link rel="stylesheet" href="https://templates.scriptsbundle.com/logistic-pro/demo/logistic-pro/fonts/Flaticon.woff">
<link rel="stylesheet" href="https://templates.scriptsbundle.com/logistic-pro/demo/logistic-pro/fonts/fontawesome-webfont.woff2?v=4.6.3">
</head>
            ...
            <nav class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html"><img alt="" src="images/logo-1.png" class="img-responsive"> </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="main-navigation">
                        <ul class="nav navbar-nav navbar-right custom-nav">
                            ...
                            <li class="dropdown"><a class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" data-animations="fadeInUp">Blog <span class="fa fa-angle-down"></span></a>
                                <ul class="dropdown-menu">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7">
          ...
          <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam excepturi quibusdam reprehenderit iste ullam odit, modi fugit aliquam repudiandae, neque nisi tempora?</p>
          <div class="form">
            <form action="history.html">
              <input type="text" class="form-control"  placeholder="Your Tracking Number eg (Sz-1170)">
              <button>Track</button>
            </form>
            <span class="declaration">We hate spam. You can trust us, we won't use your email</span>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row"> 
            ...
            <div class="section-content">
              <div class="col-md-5 col-sm-4">
                  <img alt="" class="img-absolute" src="images/phone.png">
              </div>
